...
stripe.api_key="sk_test_51PAY2WSJowAJMTYsGP5wZqryctEDxZinyXrARItGDN7xSdKTAQViNA5lS069MTaPdVnBmpb346Xwy18Q4MZPPtAJ000sG9TgUk"
...
class TestStripeImplementation(APIView):
    ...
    def post(self, request):
        test_payment_process = stripe.PaymentIntent.create(
            ...
            receipt_email='kavya.ofc0102@gmail.com'
        )
